...
DEFINE_bool(run_in_XPS_cluster, true, "Run nodes in cluster or local");
...
// DEFINE_string(conf, "10.16.27.210:8100:0,10.16.38.212:8101:0,10.16.38.109:8102:0,", "Initial configuration of the replication group");


//- Seven Node WAN
// DEFINE_string(conf, "139.196.43.84:8100:0,118.31.247.190:8101:0,118.195.176.222:8102:0,123.57.4.180:8103:0,152.136.191.215:8104:0,123.57.248.75:8105:0,101.200.180.85:8106:0,", "Initial configuration of the replication group");
//- Five Node WAN
// DEFINE_string(conf, "139.196.43.84:8100:0,118.31.247.190:8101:0,118.195.176.222:8102:0,123.57.4.180:8103:0,152.136.191.215:8104:0,", "Initial configuration of the replication group");
//- Three Node WAN
// DEFINE_string(conf, "106.15.49.53:8100:0,121.41.49.232:8101:0,172.21.147.161:8102:0", "Initial configuration of the replication group");
...
// DEFINE_string(conf, "106.14.132.83:8100:0,47.96.123.45:8101:0,47.93.52.20:8102:0,101.132.40.215:8103:0,47.96.235.119:8104:0,47.93.187.126:8105:0,101.132.148.204:8106:0,47.96.3.189:8107:0,101.201.68.127:8108:0,47.100.115.212:8109:0,47.96.237.35:8110:0", "Initial configuration of the replication group");
...
public:
    ...
    int start() {
        ...
        // std::string prefix_log_storage = "encrypted_local2://" + FLAGS_data_path;
    ...
    void fetch_add(const FetchAddRequest* request,
        ...
        // if (request->has_dummy_padding()) {
        //     VLOG(79) << "Func: " << __FUNCTION__ << " dummypadding.size = " << request->dummy_padding().size();
        // }
    ...
    void get(CounterResponse* response) {
        VLOG(80) << "Func: " << __FUNCTION__ << " Receive Get RPC...";
        ...
        response->set_value(_value.load(sgxbutil::memory_order_relaxed));
    }
...
private:
    ...
    sgxbutil::atomic<int64_t> _value;
...
int main(int argc, char* argv[]) {
    ...
    //- TODO: brpc server将监听我们在pb中定义的服务，负责传入传出操作，具体的流程是怎样的?
    ...
    options.mutable_ssl_options()->default_cert.certificate = "/home/jetli/sgx-learning/project/SGX_BRAFT/XPS_sgx_braft_v0_06_git/example/counter/cert.pem";
    options.mutable_ssl_options()->default_cert.private_key = "/home/jetli/sgx-learning/project/SGX_BRAFT/XPS_sgx_braft_v0_06_git/example/counter/key.pem";
...
#else
void start_counter_server(int port) {
    FLAGS_port = port;
    sgxbutil::AtExitManager exit_manager;
    ...
    if (server.AddService(&service, 
                          brpc::SERVER_DOESNT_OWN_SERVICE) != 0) {
        LOG(ERROR) << "Fail to add counter service";
        return ;
    }
    ...
    while (!brpc::IsAskedToQuit()) {
        sleep(2);
        LOG(INFO) << "Counter server wakes up.";
    }
