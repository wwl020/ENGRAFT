...
public:
    ...
    int save_to_iobuf_as_remote(sgxbutil::IOBuf* buf) const;
    int load_from_iobuf_as_remote(const sgxbutil::IOBuf& buf);
...
public:
    ...
    void set_server_addr(sgxbutil::EndPoint server_addr) { _addr = server_addr; }
    bool has_server_addr() { return _addr != sgxbutil::EndPoint(); }
private:
