...
struct SnapshotExecutorOptions {
    ...
    sgxscoped_refptr<FileSystemAdaptor> file_system_adaptor;
...
public:
    ...
    bool is_installing_snapshot() const { 
        ...
        return _downloading_snapshot.load(sgxbutil::memory_order_acquire/*1*/);
    }
...
friend class InstallSnapshotDone;
    ...
    void on_snapshot_load_done(const sgxbutil::Status& st);
    int on_snapshot_save_done(const sgxbutil::Status& st,
    ...
    sgxbutil::atomic<DownloadingSnapshot*> _downloading_snapshot;
