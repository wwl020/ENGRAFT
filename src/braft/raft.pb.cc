...
void protobuf_AssignDesc_braft_2fraft_2eproto() {
  ...
  static const int AppendEntriesResponse_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AppendEntriesResponse, readonly_),
  };
...
void protobuf_AddDesc_braft_2fraft_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "dex\030\001 \002(\003\022\032\n\022last_included_term\030\002 \002(\003\022\r\n"
    "\005peers\030\003 \003(\t\022\021\n\told_peers\030\004 \003(\t\"\214\001\n\026Inst"
    "allSnapshotRequest\022\020\n\010group_id\030\001 \002(\t\022\021\n\t"
    "server_id\030\002 \002(\t\022\017\n\007peer_id\030\003 \002(\t\022\014\n\004term"
    "\030\004 \002(\003\022!\n\004meta\030\005 \002(\0132\023.braft.SnapshotMet"
    "a\022\013\n\003uri\030\006 \002(\t\"8\n\027InstallSnapshotRespons"
    "e\022\014\n\004term\030\001 \002(\003\022\017\n\007success\030\002 \002(\010\"W\n\021Time"
    "outNowRequest\022\020\n\010group_id\030\001 \002(\t\022\021\n\tserve"
    "r_id\030\002 \002(\t\022\017\n\007peer_id\030\003 \002(\t\022\014\n\004term\030\004 \002("
    "\003\"3\n\022TimeoutNowResponse\022\014\n\004term\030\001 \002(\003\022\017\n"
    "\007success\030\002 \002(\0102\373\002\n\013RaftService\022A\n\010pre_vo"
    "te\022\031.braft.RequestVoteRequest\032\032.braft.Re"
    "questVoteResponse\022E\n\014request_vote\022\031.braf"
    "t.RequestVoteRequest\032\032.braft.RequestVote"
    "Response\022K\n\016append_entries\022\033.braft.Appen"
    "dEntriesRequest\032\034.braft.AppendEntriesRes"
    "ponse\022Q\n\020install_snapshot\022\035.braft.Instal"
    "lSnapshotRequest\032\036.braft.InstallSnapshot"
    "Response\022B\n\013timeout_now\022\030.braft.TimeoutN"
    "owRequest\032\031.braft.TimeoutNowResponseB\003\200\001"
    "\001", 1481);
...
const EntryMeta& EntryMeta::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_braft_2fraft_2eproto();  return *default_instance_;
}
