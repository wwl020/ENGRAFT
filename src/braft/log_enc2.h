...
class BAIDU_CACHELINE_ALIGNMENT EncryptedSegmentTest 
        : public sgxbutil::RefCountedThreadSafe<EncryptedSegmentTest> {
public:
...
private:
friend class sgxbutil::RefCountedThreadSafe<EncryptedSegmentTest>;
...
public:
    typedef std::map<int64_t, sgxscoped_refptr<EncryptedSegmentTest> > SegmentMap;
    ...
    void sync();
private:
    sgxscoped_refptr<EncryptedSegmentTest> open_segment();
    ...
    int get_segment(int64_t log_index, sgxscoped_refptr<EncryptedSegmentTest>* ptr);
    void pop_segments(
            int64_t first_index_kept, 
            std::vector<sgxscoped_refptr<EncryptedSegmentTest> >* poped);
    ...
    sgxscoped_refptr<EncryptedSegmentTest> _open_segment;
    bool _enable_sync;
};
