...
private:
    ...
    typedef std::map<NodeId, sgxscoped_refptr<NodeImpl> > NodeMap;
    ...
    sgxbutil::DoublyBufferedData<Maps> _nodes;

    raft_mutex_t _mutex;
    std::set<sgxbutil::EndPoint> _addr_set;
};
