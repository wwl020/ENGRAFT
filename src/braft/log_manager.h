...
#include "sgxbutil/atomicops.h"                   // atomic
...
public:
    ...
    // Returns sgxbutil::Status::OK if valid, a specific error otherwise
    sgxbutil::Status check_consistency();
...
friend class AppendBatcher;
    ...
    raft_mutex_t _mutex;
    sgxbutil::FlatMap<int64_t, WaitMeta*> _wait_map;
    bool _stopped;
    sgxbutil::atomic<bool> _has_error;
