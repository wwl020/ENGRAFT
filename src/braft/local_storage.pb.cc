...
void protobuf_AssignDesc_braft_2flocal_5fstorage_2eproto() {
  ...
  static const int LogPBMeta_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LogPBMeta, first_log_index_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LogPBMeta, last_log_index_),
  };
...
void protobuf_AddDesc_braft_2flocal_5fstorage_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "_log_index\030\001 \002(\003\022\026\n\016last_log_index\030\002 \001(\003"
    "\".\n\014StablePBMeta\022\014\n\004term\030\001 \002(\003\022\020\n\010votedf"
    "or\030\002 \002(\t\"\242\001\n\023LocalSnapshotPbMeta\022!\n\004meta"
    "\030\001 \001(\0132\023.braft.SnapshotMeta\022.\n\005files\030\002 \003"
    "(\0132\037.braft.LocalSnapshotPbMeta.File\0328\n\004F"
    "ile\022\014\n\004name\030\001 \002(\t\022\"\n\004meta\030\002 \001(\0132\024.braft."
    "LocalFileMeta", 413);
...
const ConfigurationPBMeta& ConfigurationPBMeta::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_braft_2flocal_5fstorage_2eproto();  return *default_instance_;
}
...
const int LogPBMeta::kLastLogIndexFieldNumber;
#endif  // !_MSC_VER
...
void LogPBMeta::SerializeWithCachedSizes(
  ...
  if (has_last_log_index()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(2, this->last_log_index(), output);
  }
...
::google::protobuf::uint8* LogPBMeta::SerializeWithCachedSizesToArray(
  ...
  // optional int64 last_log_index = 2;
  if (has_last_log_index()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(2, this->last_log_index(), target);
  }
