...
public:
    ...
    int save(const ::google::protobuf::Message* message, bool sync, sgxbutil::CounterID* counter_id, int flag);
    //- Update counter_id if load successfully.
    int load(::google::protobuf::Message* message, sgxbutil::CounterID* counter_id, int flag);
