...
#include "sgxbutil/containers/linked_list.h"
...
class BAIDU_CACHELINE_ALIGNMENT NodeImpl 
        : public sgxbutil::RefCountedThreadSafe<NodeImpl> {
...
public:
    ...
    int increase_term_to(int64_t new_term, const sgxbutil::Status& status);
...
private:
friend class sgxbutil::RefCountedThreadSafe<NodeImpl>;
    ...
    void reset_leader_id(const PeerId& new_leader_id, const sgxbutil::Status& status);
    ...
    void do_apply(sgxbutil::IOBuf& data, Closure* done);
...
private:
    ...
    public:
        ...
        void reset(sgxbutil::Status* st = NULL);
    ...
    struct AppendEntriesRpc : public sgxbutil::LinkNode<AppendEntriesRpc> {
    ...
    struct HandleAppendEntriesFromCacheArg {
        NodeImpl* node;
        sgxbutil::LinkedList<AppendEntriesRpc> rpcs;
    };
    ...
    private:
        ...
        NodeImpl* _node;
        sgxbutil::LinkedList<AppendEntriesRpc> _rpc_queue;
