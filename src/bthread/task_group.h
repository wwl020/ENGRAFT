...
#include "sgxbutil/time.h"                             // cpuwide_time_ns
...
#include "sgxbutil/resource_pool.h"                    // ResourceId
...
public:
    ...
    { return sgxbutil::cpuwide_time_ns() - _cur_meta->cpuwide_start_ns; }
    ...
    void flush_nosignal_tasks_remote_locked(sgxbutil::Mutex& locked_mutex);
