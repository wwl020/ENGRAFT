...
#ifndef SGX_BUTIL_MEMORY_SINGLETON_ON_PTHREAD_ONCE_H
#define SGX_BUTIL_MEMORY_SINGLETON_ON_PTHREAD_ONCE_H
...
public:
    static sgxbutil::subtle::AtomicWord g_leaky_singleton_untyped;
    static pthread_once_t g_create_leaky_singleton_once;
    static void create_leaky_singleton();
};
template <typename T>
sgxbutil::subtle::AtomicWord GetLeakySingleton<T>::g_leaky_singleton_untyped = 0;
...
void GetLeakySingleton<T>::create_leaky_singleton() {
    ...
    sgxbutil::subtle::Release_Store(
        ...
        reinterpret_cast<sgxbutil::subtle::AtomicWord>(obj));
}
...
inline T* get_leaky_singleton() {
    const sgxbutil::subtle::AtomicWord value = sgxbutil::subtle::Acquire_Load(
...
inline T* has_leaky_singleton() {
    return reinterpret_cast<T*>(
        sgxbutil::subtle::Acquire_Load(
            &GetLeakySingleton<T>::g_leaky_singleton_untyped));
}

} // namespace sgxbutil

#endif // SGX_BUTIL_MEMORY_SINGLETON_ON_PTHREAD_ONCE_H
