...
#ifndef SGX_BUTIL_MEMORY_ALIGNED_MEMORY_H_
#define SGX_BUTIL_MEMORY_ALIGNED_MEMORY_H_
...
//   scoped_ptr<Foo, sgxbutil::AlignedFreeDeleter> foo;
...
#endif  // SGX_BUTIL_MEMORY_ALIGNED_MEMORY_H_
