...
#ifndef SGXBUTIL_CASE_IGNORED_FLAT_MAP_H
#define SGXBUTIL_CASE_IGNORED_FLAT_MAP_H
...
struct CaseIgnoredEqual {
    // NOTE: No overload for sgxbutil::StringPiece. It needs strncasecmp
...
template <typename T>
class CaseIgnoredFlatMap : public sgxbutil::FlatMap<
    std::string, T, CaseIgnoredHasher, CaseIgnoredEqual> {};

class CaseIgnoredFlatSet : public sgxbutil::FlatSet<
    std::string, CaseIgnoredHasher, CaseIgnoredEqual> {};

} // namespace sgxbutil

#endif  // SGXBUTIL_CASE_IGNORED_FLAT_MAP_H
