...
#ifndef SGXBUTIL_SYNCHRONIZATION_CONDITION_VARIABLE_H_
#define SGXBUTIL_SYNCHRONIZATION_CONDITION_VARIABLE_H_
...
#endif  // SGXBUTIL_SYNCHRONIZATION_CONDITION_VARIABLE_H_
