...
//- TODO: When debugging outside the enclave, please use butil/basictypes.h
//- to avoid collision
#ifndef SGX_BUTIL_BASICTYPES_H_
#define SGX_BUTIL_BASICTYPES_H_
...
#include "sgxbutil/port.h"  // Types that only need exist on certain systems.
