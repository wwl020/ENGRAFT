...
#ifdef __SSE4_2__
  #ifdef __clang__
    // #include "sgxbutil/third_party/crc32/clang8_crc32/nmmintrin.h"
    #include <nmmintrin.h>
  #else
    #include "sgxbutil/third_party/crc32/gcc7_5_crc32/nmmintrin.h"
  #endif //#ifdef __clang__
#endif  // #ifdef __SSE4_2__

//- In Intel x86, ARCH_CPU_LITTLE_ENDIAN=1, so we don't need this config file.
