...
#ifndef SGX_BUTIL_ATOMIC_REF_COUNT_H_
#define SGX_BUTIL_ATOMIC_REF_COUNT_H_

#include "sgxbutil/atomicops.h"
//- We don't use any binary analysis tools in sgx-braft
...
inline void AtomicRefCountInc(volatile AtomicRefCount *ptr) {
  sgxbutil::AtomicRefCountIncN(ptr, 1);
}
...
inline bool AtomicRefCountDec(volatile AtomicRefCount *ptr) {
  return sgxbutil::AtomicRefCountDecN(ptr, 1);
}
...
#endif  // SGX_BUTIL_ATOMIC_REF_COUNT_H_
