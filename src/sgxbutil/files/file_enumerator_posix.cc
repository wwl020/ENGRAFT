...
// sgxbutil::Time FileEnumerator::FileInfo::GetLastModifiedTime() const {
//   return sgxbutil::Time::FromTimeT(stat_.st_mtime);
// }
...
#else
  //- TODO: OE support readdir but not readdir_r, so change it. This should be fine.
