...
#include "sgxbutil/third_party/modp_b64/modp_b64.h"
//- 与modp相关的文件暂时改名为sgxbutil/third_party/modp_b64/modp_b64.cc.todo，防止定义冲突

//- TODO: 先使用butil版本，防止重复定义
// #include "butil/third_party/modp_b64/modp_b64.h"
