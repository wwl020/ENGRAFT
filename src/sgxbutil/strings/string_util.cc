...
#include "sgxbutil/strings/utf_string_conversion_utils.h"
// #include "butil/strings/utf_string_conversions.h"
#include "sgxbutil/third_party/icu/icu_utf.h"
// #include "butil/build_config.h"

// Remove when this entire file is in namespace butil.
// using sgxbutil::char16;
// using sgxbutil::string16;
...
//                              TrimPositions positions,
//                              string16* output) {
//   return TrimStringT(input, sgxbutil::string16(kWhitespaceUTF16), positions,
//                      output);
// }
...
static inline bool DoLowerCaseEqualsASCII(Iter a_begin,
  ...
  for (Iter it = a_begin; it != a_end; ++it, ++b) {
    if (!*b || sgxbutil::ToLowerASCII(*it) != *b)
      return false;
  }
  return *b == 0;
}
...
// // bool EqualsASCII(const string16& a, const sgxbutil::StringPiece& b) {
...
//   else
//     return sgxbutil::strncasecmp(str.c_str(), search.c_str(), search.length()) == 0;
// }
...
//                       sgxbutil::CaseInsensitiveCompare<typename STR::value_type>());
//   }
// }
...
// //     sgxbutil::snprintf(buf, arraysize(buf), "%.1lf%s", unit_amount,
// //                    kByteStringsUnlocalized[dimension]);
// //   } else {
// //     sgxbutil::snprintf(buf, arraysize(buf), "%.0lf%s", unit_amount,
// //                    kByteStringsUnlocalized[dimension]);
// //   }

// //   return sgxbutil::ASCIIToUTF16(buf);
// // }
...
// size_t Tokenize(const sgxbutil::StringPiece& str,
...
// std::string ReplaceStringPlaceholders(const sgxbutil::StringPiece& format_string,
...
// bool MatchPattern(const sgxbutil::StringPiece& eval,
...
size_t sgxbutil::strlcpy(char* dst, const char* src, size_t dst_size) {
  return lcpyT<char>(dst, src, dst_size);
}
size_t sgxbutil::wcslcpy(wchar_t* dst, const wchar_t* src, size_t dst_size) {
