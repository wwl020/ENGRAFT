...
//- Eliminate string16 things and some unused functions to keep porting simple
#ifndef SGX_BUTIL_STRINGS_STRING_PIECE_H_
#define SGX_BUTIL_STRINGS_STRING_PIECE_H_
...
//- basictypes.h seems to be useless
// #include "sgxbutil/basictypes.h"

//- TODO: hash_tables may be useless
...
//- TODO: Following code may not be used.
...
// template<>
// struct hash<sgxbutil::StringPiece> {
//   std::size_t operator()(const sgxbutil::StringPiece& sp) const {
//     HASH_STRING_PIECE(sgxbutil::StringPiece, sp);
//   }
// };
// // template<>
// // struct hash<sgxbutil::StringPiece16> {
...
#endif  // SGX_BUTIL_STRINGS_STRING_PIECE_H_
