...
#ifndef SGX_BUTIL_STRINGS_STRING_NUMBER_CONVERSIONS_H_
#define SGX_BUTIL_STRINGS_STRING_NUMBER_CONVERSIONS_H_
...
#endif  // SGX_BUTIL_STRINGS_STRING_NUMBER_CONVERSIONS_H_
