...
#ifndef SGX_BUTIL_STRINGS_STRING_UTIL_H_
#define SGX_BUTIL_STRINGS_STRING_UTIL_H_
...
#include "sgxbutil/strings/string_piece.h"  // For implicit conversions.
...
// cross-platform are provided as "sgxbutil::strncasecmp", and their prototypes
...
//
// This function is intended to be called from sgxbutil::vswprintf.
...
//                              const sgxbutil::StringPiece16& remove_chars,
//                              string16* output);
BUTIL_EXPORT bool RemoveChars(const std::string& input,
                             const sgxbutil::StringPiece& remove_chars,
                             std::string* output);
...
//                               const sgxbutil::StringPiece16& replace_chars,
//                               const string16& replace_with,
//                               string16* output);
BUTIL_EXPORT bool ReplaceChars(const std::string& input,
                              const sgxbutil::StringPiece& replace_chars,
...
//                             const sgxbutil::StringPiece16& trim_chars,
//                             string16* output);
BUTIL_EXPORT bool TrimString(const std::string& input,
                            const sgxbutil::StringPiece& trim_chars,
                            std::string* output);
...
#include "sgxbutil/strings/string_util_posix.h"
...
// BUTIL_EXPORT bool LowerCaseEqualsASCII(const sgxbutil::string16& a, const char* b);

// Same thing, but with string iterators instead.
BUTIL_EXPORT bool LowerCaseEqualsASCII(std::string::const_iterator a_begin,
                                      std::string::const_iterator a_end,
                                      const char* b);
// BUTIL_EXPORT bool LowerCaseEqualsASCII(sgxbutil::string16::const_iterator a_begin,
//                                       sgxbutil::string16::const_iterator a_end,
//                                       const char* b);
BUTIL_EXPORT bool LowerCaseEqualsASCII(const char* a_begin,
                                      const char* a_end,
                                      const char* b);
// BUTIL_EXPORT bool LowerCaseEqualsASCII(const sgxbutil::char16* a_begin,
//                                       const sgxbutil::char16* a_end,
//                                       const char* b);

// Performs a case-sensitive string compare. The behavior is undefined if both
// strings are not ASCII.
// BUTIL_EXPORT bool EqualsASCII(const sgxbutil::string16& a, const sgxbutil::StringPiece& b);

// Returns true if str starts with search, or false otherwise.
BUTIL_EXPORT bool StartsWithASCII(const std::string& str,
                                 const std::string& search,
                                 bool case_sensitive);
// BUTIL_EXPORT bool StartsWith(const sgxbutil::string16& str,
//                             const sgxbutil::string16& search,
//                             bool case_sensitive);
...
BUTIL_EXPORT bool EndsWith(const std::string& str,
                          const std::string& search,
                          bool case_sensitive);
// BUTIL_EXPORT bool EndsWith(const sgxbutil::string16& str,
//                           const sgxbutil::string16& search,
//                           bool case_sensitive);
...
inline bool IsWhitespace(wchar_t c) {
  return wcschr(sgxbutil::kWhitespaceWide, c) != NULL;
}
...
// BUTIL_EXPORT sgxbutil::string16 FormatBytesUnlocalized(int64_t bytes);

// Starting at |start_offset| (usually 0), replace the first instance of
// |find_this| with |replace_with|.
// BUTIL_EXPORT void ReplaceFirstSubstringAfterOffset(
//     sgxbutil::string16* str,
//     size_t start_offset,
//     const sgxbutil::string16& find_this,
//     const sgxbutil::string16& replace_with);
BUTIL_EXPORT void ReplaceFirstSubstringAfterOffset(
    std::string* str,
    size_t start_offset,
...
// BUTIL_EXPORT size_t Tokenize(const sgxbutil::string16& str,
//                             const sgxbutil::string16& delimiters,
//                             std::vector<sgxbutil::string16>* tokens);
BUTIL_EXPORT size_t Tokenize(const std::string& str,
                            const std::string& delimiters,
                            std::vector<std::string>* tokens);
BUTIL_EXPORT size_t Tokenize(const sgxbutil::StringPiece& str,
                            const sgxbutil::StringPiece& delimiters,
                            std::vector<sgxbutil::StringPiece>* tokens);

// Does the opposite of SplitString().
// BUTIL_EXPORT sgxbutil::string16 JoinString(const std::vector<sgxbutil::string16>& parts,
//                                       sgxbutil::char16 s);
...
// BUTIL_EXPORT sgxbutil::string16 JoinString(
//     const std::vector<sgxbutil::string16>& parts,
//     const sgxbutil::string16& separator);

// Replace $1-$2-$3..$9 in the format string with |a|-|b|-|c|..|i| respectively.
// Additionally, any number of consecutive '$' characters is replaced by that
// number less one. Eg $$->$, $$$->$$, etc. The offsets parameter here can be
// NULL. This only allows you to use up to nine replacements.
// BUTIL_EXPORT sgxbutil::string16 ReplaceStringPlaceholders(
//     const sgxbutil::string16& format_string,
//     const std::vector<sgxbutil::string16>& subst,
//     std::vector<size_t>* offsets);

BUTIL_EXPORT std::string ReplaceStringPlaceholders(
    const sgxbutil::StringPiece& format_string,
...
BUTIL_EXPORT bool MatchPattern(const sgxbutil::StringPiece& string,
                              const sgxbutil::StringPiece& pattern);
// BUTIL_EXPORT bool MatchPattern(const sgxbutil::string16& string,
//                               const sgxbutil::string16& pattern);
...
struct ToUnsigned<wchar_t> {
  //- Presume that WCHAR_T_IS_UTF32 is defined in butil/build_config.h
...
#endif  // SGX_BUTIL_STRINGS_STRING_UTIL_H_
