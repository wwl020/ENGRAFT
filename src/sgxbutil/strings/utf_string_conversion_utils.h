...
#ifndef SGX_BUTIL_STRINGS_UTF_STRING_CONVERSION_UTILS_H_
#define SGX_BUTIL_STRINGS_UTF_STRING_CONVERSION_UTILS_H_
...
#endif  // SGX_BUTIL_STRINGS_UTF_STRING_CONVERSION_UTILS_H_
