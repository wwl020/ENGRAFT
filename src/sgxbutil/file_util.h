...
#ifndef SGX_BUTIL_FILE_UTIL_H_
#define SGX_BUTIL_FILE_UTIL_H_
...
#include "sgxbutil/memory/scoped_ptr.h"
// #include "butil/strings/string16.h"

#include "sgxbutil/file_descriptor_posix.h"
// #include "sgxbutil/logging.h"
#include "sgxbutil/posix/eintr_wrapper.h"

namespace sgxbutil {

//- We don't need time-related file access functions in sgx-braft , e.g., TouchFile(xxx)
// class Time;
...
BUTIL_EXPORT bool VerifyPathControlledByUser(const sgxbutil::FilePath& base,
                                            const sgxbutil::FilePath& path,
                                            uid_t owner_uid,
...
BUTIL_EXPORT int GetMaximumPathComponentLength(const sgxbutil::FilePath& path);
...
typedef sgxscoped_ptr<FILE, ScopedFILEClose> ScopedFILE;
