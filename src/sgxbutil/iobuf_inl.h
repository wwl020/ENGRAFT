...
#ifndef SGX_BUTIL_IOBUF_INL_H
#define SGX_BUTIL_IOBUF_INL_H
...
inline IOBufBytesIterator::IOBufBytesIterator(const sgxbutil::IOBuf& buf)
...
inline void IOBufBytesIterator::try_next_block() {
    ...
    sgxbutil::StringPiece s = _buf->backing_block(_block_count++);
    _block_begin = s.data();
