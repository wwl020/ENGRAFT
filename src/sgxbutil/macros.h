...
#ifndef SGX_BUTIL_MACROS_H_
#define SGX_BUTIL_MACROS_H_

#include <stddef.h>  // For size_t.
#include <string.h>  // For memcpy.

#include "sgxbutil/compiler_specific.h"  // For ALLOW_UNUSED.
...
#define arraysize(array) (sizeof(::sgxbutil::ArraySizeHelper(array)))
...
# define DEFINE_SMALL_ARRAY(Tp, name, size, maxsize)                    \
    ...
    ::sgxbutil::internal::ArrayDeleter<Tp> name##_array_deleter;            \
...
# define DEFINE_SMALL_ARRAY(Tp, name, size, maxsize)                    \
    ...
    ::sgxbutil::internal::ArrayDeleter<char> name##_array_deleter;          \
    if (name##_stack_array_size) {                                      \
    ...
    const ::sgxbutil::internal::ArrayCtorDtor<Tp> name##_array_ctor_dtor(name, name##_size);
...
//- TODO: Following code my not be used in sgx-braft.
